...
from .models import Free_Listing, Advertise_with_Us, Subcategory, Comment, Customer, Skill, Product, Supplier, Stock, SaleBill, SaleItem, PurchaseBill, PurchaseItem, QuotationBill, QuotationItem
...
class Free_ListingForm(forms.ModelForm):
    ...
    class Meta:
        model = Free_Listing
        fields = ['Business_Name', 'Business_Category', 'Business_Subcategory', 'Business_Telephone', 'Business_WhatsApp', 'Business_Location', 'Business_Email', 'Business_Website', 'Business_Facebook', 'Business_Instagram', 'Business_Twitter', 'Business_Linkedin', 'Business_Pinterest', 'Business_Github', 'Business_Description','tags', 'Business_Logo', 'Business_Images', 'Business_Established_Date']
        widgets = {
...
class Advertise_With_UsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'Business_Category' in self.data:
            ...
            self.fields['Business_Subcategory'].queryset = self.instance.Business_Category.Business_Subcategory_Set.order_by('name')
...
class SkillForm(forms.ModelForm):
    class Meta:
        model = Skill
        fields = ['name', 'excellence',]

class ProductForm(forms.ModelForm):
    class Meta:
        model = Product
        fields = ['name', 'shop', 'image', 'desc', 'price', 'offer_price',]
...
class StockForm(forms.ModelForm):
    class Meta:
        model = Stock
        fields = ['name', 'shop', 'supplier', 'quantity', 'image', 'hsn',]
...
class PurchaseItemForm(forms.ModelForm):
    class Meta:
        model = PurchaseItem
        fields = ['stock', 'quantity', 'perPrice', 'cgst', 'sgst', 'igst']
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        self.fields['cgst'].widget.attrs.update({'class':'form-control'})
        self.fields['sgst'].widget.attrs.update({'class':'form-control'})
        self.fields['igst'].widget.attrs.update({'class':'form-control'})
