...
class Subcategory(models.Model):
    ...
    name = models.CharField(max_length=50)
    slug = models.SlugField(unique=True, null=True, blank=True)
    icon = models.ImageField(upload_to='subcategories/icons', validators=[FileExtensionValidator(['png', 'jpg', 'jpeg'])], null=True, blank=True)
...
class Free_Listing(models.Model):
    ...
    Business_Subcategory = models.ManyToManyField(Subcategory, max_length=5)
    ...
    Business_Location = LocationField()
    Business_Address = AddressAutoHiddenField(null=True, blank=True)
    ...
    Business_Images = models.ImageField(upload_to=listing_images_directory_path, validators=[FileExtensionValidator(['png', 'jpg', 'jpeg'])], verbose_name='Business Images', null=True, blank=True)
...
class Skill(models.Model):
    ...
    excellence = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(100)], default=0, help_text='Value between 0 & 100')
...
class PurchaseItem(models.Model):
    ...
    cgst = models.FloatField(('CGST (in %)'), null=True, blank=True)
    sgst = models.FloatField(('SGST (in %)'), null=True, blank=True)
    igst = models.FloatField(('IGST (in %)'), null=True, blank=True)
