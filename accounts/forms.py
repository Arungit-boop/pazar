...
class ProfileForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields = [
            'age','birthday','gender','bio','description','address','phone_no','website','facebook','instagram',
...
class PostForm(forms.ModelForm):
    pic = forms.FileField(widget=forms.ClearableFileInput(attrs={'multiple':True, 'class':'form-control'}), required=True)
