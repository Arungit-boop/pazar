...
class Profile(models.Model):
    ...
    favourites = models.ManyToManyField('accounts.Post')
...
class Notification(models.Model):
    ...
    # def __str__(self):
    #     return self.notification_type + " notification of post " + " (" +  self.post + ")" + " posted by " + self.user
...
class Post(models.Model):
    ...
    # liked = models.ManyToManyField(CustomUser, related_name='likes')
