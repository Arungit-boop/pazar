...
from accounts.views import activation_sent_view, activate, ProfileEditView, ProfileView, post_comment_create_and_list_view, like, unlike, favourite, PostDetail, likePost, unlikePost, tags, PostDeleteView, PostEditView, showNotifications, DeleteNotification
